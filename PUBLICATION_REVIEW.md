...
- **G5 rights/provenance**: SOURCE_PROVENANCE.yaml entries present; **formal external rights review pending** — see `RIGHTS_REVIEW.md` (PROV-LEGAL-001 lawllama-assurance MIT, PROV-LEGAL-002 scaffold clean-room/CourtListener).
